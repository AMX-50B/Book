...
<!--
	...
	function searchName() {
			...
			if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
				...
				if(jsonObj.length>0){
					...
					for ( var i = 0; i < jsonObj.length; i++) {
						div.innerHTML += "<div onclick='fillNameValue(this)' onmouseover='changeBackground_over(this)' onmouseout='changeBackground_out(this)'style='text-align:center'>"
								+ jsonObj[i] + "</div>"
					}
				}
		...
		//3.open
		xmlhttp.open("GET",
				"${pageContext.request.contextPath}/findProductByAjax?name="
	...
	function changeBackground_out(div){
		div.style.background="RGB(250,250,220)";
	}
//-->
</script>
...
<div id="content"
	style="background-color:RGB(250,250,220);width:128px;max-height:150px;overflow-y:auto;position: absolute; text-align:left;margin-left:945px;color:black;float:left;margin-top: -20px;display: none">
</div>