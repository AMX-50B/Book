			...
			<tr>
				...
				<td><div style="text-align:right; margin:5px 10px 5px 0px">
						<a href="index.jsp">首页</a>&nbsp;&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;<a
							href="${pageContext.request.contextPath}/accountServlet">&nbsp;我的帐户</a>&nbsp;&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;&nbsp;订单查询
					</div>
						...
						<tr>
							<td style="padding:20px"><p>欢迎${user.username}光临商城！</p>
								...
								<table width="100%" border="0" cellspacing="0" class="tableopen">
									...
									<c:forEach items="${list}" var="od" varStatus="va">
									<tr>
										<td class="tableopentd02">${od.id}</td>

										<td class="tableopentd02">${od.recieverName}</td>
										<td class="tableopentd02">${od.orderTime}</td>
										<td class="tableopentd02">${od.payState>0?"已支付":"未支付"}</td>
										<td class="tableopentd03"><a href="${pageContext.request.contextPath}/showOrderInfoServlet?id=${od.id}">查看</a>&nbsp;&nbsp;
											<a href="${pageContext.request.contextPath}/deleteOrderServlet?id=${od.id}">取消</a>
										</td>
									</tr>
									</c:forEach>
