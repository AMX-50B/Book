								...
								<td><table width="100%" border="0" cellspacing="0">
										...
										<tr>
											<td><table cellspacing="1" class="carttable">
												...
												<c:forEach items="${cart}" var="cart" varStatus="va">
												<table width="100%" border="0" cellspacing="0">
													<tr>
												...
												<table cellspacing="1" class="carttable">
													...
													<input name="money" value="${sum}" type="hidden"/>
												</table>
												...
												<p style="text-align:right">
													<img src="images/gif53_029.gif" width="204" height="51" onclick="_submit()" border="0" />
												</p></td>
										</tr>
									</table></td>
							</tr>
